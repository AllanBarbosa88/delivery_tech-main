...
-- 🛵 NOVO: USUÁRIOS COM PERFIL DE ENTREGADOR (Para permitir autenticação via JWT)
-- Considerando o padrão de criptografia do Spring Security (Texto limpo '@123' ou hash BCrypt se configurado no seu projeto)
INSERT INTO usuario (nome, email, senha, role, ativo, data_criacao) VALUES ('Carlos Motoboy', 'carlos@entregador.com', '$2a$10$7R9Mv6qg8wU7v0A9b8c7d.eFghIjKlMnOpQrStUvWxYz123456789', 'ENTREGADOR', true, CURRENT_TIMESTAMP);
INSERT INTO usuario (nome, email, senha, role, ativo, data_criacao) VALUES ('Roberto Entregas', 'roberto@entregador.com', '$2a$10$7R9Mv6qg8wU7v0A9b8c7d.eFghIjKlMnOpQrStUvWxYz123456789', 'ENTREGADOR', true, CURRENT_TIMESTAMP);

-- 🛵 NOVO: TABELA DE STATUS DO ENTREGADOR (Se o projeto gerenciar os dados de veículo/status em tabela separada)
-- Caso sua tabela use o padrão "entregador", os registros abaixo vinculam aos IDs criados acima
